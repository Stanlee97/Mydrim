...
$(document).ready(function(){
  ...
  if ($('#nav-menu-container').length) {
    ...
    $('#header .row').append('<button type="button" id="mobile-nav-toggle"><i class="fas fa-bars"></i></button>');
    ...
    //  Start Google map 
            ...
            function initMap() {
                try {
                    ...
                    var mapOptions = {
                        zoom: 15,
                        center: new google.maps.LatLng(6.4588, 3.4274), // Ikoyi, Lagos
                    ...
                    var marker = new google.maps.Marker({
                        position: new google.maps.LatLng(6.4588, 3.4274),
                        map: map,
                        title: 'Mydrim Gallery - 74b Norman Williams Street, Ikoyi, Lagos'
                    });
